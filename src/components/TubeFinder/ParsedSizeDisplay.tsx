...
export function ParsedSizeDisplay({ parsed }: ParsedSizeDisplayProps) {
  ...
  return (
    <div
      className={cn(
        ...
        isLowConfidence ? "bg-warning/10 border border-warning/20" : "bg-success/10 border border-success/20"
      )}
    >
      {isLowConfidence ? (
